...
bool dataPrint_mode_g = false;  /** < toggle for printing out data > */
bool eventPrint_mode_g = false; /** < toggle for printing off events > */
bool filterPrint_mode_g = false; /** <toggle for printing out filtered data > */
